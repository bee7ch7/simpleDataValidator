...
if (is_array($product_lines)) {
	...
	if ($product['type'] == 'BV' or $product['type'] == 'BVI') {
		array_push($bvi_products,$product);
	} elseif ($product['type'] == 'CS') {
...
if (!empty($bvi_products)) {
print_r($bvi_products);
}
